  ...
  return (
    <>
      ...
      <div className="flex w-full flex-col items-center  mt-5">
        <nav
          ref={navRef}
          className="flex justify-between w-full p-3 max-w-[1280px] border-b-2"
        >
          ...
          <div className="header-right flex justify-end gap-5 ">
            <div className="input-header relative w-full  max-w-[350px] h-full  ">
              <input
                type="text"
                ref={inputRef}
