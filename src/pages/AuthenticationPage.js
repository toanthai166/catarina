...
const AuthenticationPage = ({ children }) => {
  return (
    <div className="flex container items-center justify-center flex-col">
      ...
      <div className="login flex items-center justify-start mb-10 h-[40px] gap-x-10  w-[800px]">
        <Button className="max-w-[350px] w-full text-sm   bg-[#4285f4] relative">
        ...
        <Button className=" w-full max-w-[350px] text-sm   bg-[#1e5ec5] relative">
          <span className="absolute h-5 w-5 left-[25%] -translate-x-[100%]">
